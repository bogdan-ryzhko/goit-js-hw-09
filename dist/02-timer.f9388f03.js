...
const options = {
    ...
    onClose (selectedDates) {
        ...
        (0, _notiflix.Notify).success("Correct");
        refs.startBtnRef.disabled = false;
        refs.resetBtnRef.disabled = false;
    }
};
const timerPicker = (0, _flatpickrDefault.default)("#datetime-picker", options);
const timer = new (0, _timerDefault.default)(".timer", timerPicker);
...
},{"notiflix":"5z0Oc","flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","./timer":"9Okty","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"eVN6V":[function() {},{}],"9Okty":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Timer {
    ...
    start() {
        ...
        this.timerId = setInterval(()=>{
            ...
            if (this.amountDaysRef.textContent === "00" && this.amountHoursRef.textContent === "00" && this.amountMinsRef.textContent === "00" && this.amountSecsRef.textContent === "00") this.stop();
        }, 1000);
    }
    stop() {
        if (this.isActive) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8lKsl","1AWyZ"], "1AWyZ", "parcelRequired7c6")
